...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-background to-orange-50 dark:from-blue-950/30 dark:via-background dark:to-orange-950/30">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        >
          <p className="text-xl md:text-2xl text-muted-foreground">
            Storyboard Artist • 2D Animator • Character Designer
          </p>
        </motion.div>
